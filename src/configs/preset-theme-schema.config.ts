...
const pinkTheme: ThemeVariables = {
    light: {
        primary: '#ff6fa5',        // main pink
        primaryDeep: '#e0558f',    // darker shade
        primaryMild: '#ff9fc4',    // lighter shade
        primarySubtle: '#ff6fa51a',// transparent soft bg
        neutral: '#ffffff',
    },
    dark: {
        primary: '#ff6fa5',
